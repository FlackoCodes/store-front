    ...
    <div className="w-[96%] mx-auto">
      <div className="flex my-8 space-x-1 md:space-x-2 text-[#8B96A5] items-center">
        ...
        <div className="flex items-center">
          <span className="text-sm md:text-base">Barbie Dream Eats</span>
        </div>
      </div>

      <div className="w-[93%] mx-auto  flex flex-col md:flex-row gap-4">
        {vendorOne.map((data, index) => <div className="flex flex-col md:flex-row gap-4" key={index}> <div className="flex-1">
          <img
            src={data.image}
            alt="cake"
          ...
          <div className="flex-1 flex flex-col gap-4 mr-8">
            <div className="flex flex-col gap-2">
              <h4 className="text-[#3084A9] font-semibold uppercase">{data.name}</h4>
              ...
              <h3 className="text-[#1F252C] font-bold text-xl">¢{data.price}</h3>
            </div>
            <div>
