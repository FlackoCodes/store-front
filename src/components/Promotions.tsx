      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="relative">
          <img
            src={cakeProm}
            alt="cake image"
            className="rounded-sm w-[679px] h-[640px]"
          />
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <div className="grid grid-cols-4 gap-4 w-full max-w-xs">
              <div className="bg-white p-2 rounded-md flex flex-col items-center text-center">
                <h4 className="text-lg font-semibold text-[#3084A9]">Days</h4>
                <p className="text-xl text-black">01</p>
              </div>
              <div className="bg-white p-2 rounded-md flex flex-col items-center text-center">
                <h4 className="text-lg font-semibold text-[#3084A9]">Hours</h4>
                <p className="text-xl text-black">12</p>
              </div>
              <div className="bg-white p-2 rounded-md flex flex-col items-center text-center">
                <h4 className="text-lg font-semibold text-[#3084A9]">
                  Minutes
                </h4>
